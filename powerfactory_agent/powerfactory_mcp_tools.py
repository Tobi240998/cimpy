...
# ------------------------------------------------------------------
# Data Source-Entscheidungsblock: Entscheidung, ob Basisdaten, Lastflussergebnis oder mehrdeutiger Fall vorliegt und Entscheidung, ob es sich um einen technischen Namen oder eine Beschreibung handelt
# ------------------------------------------------------------------
